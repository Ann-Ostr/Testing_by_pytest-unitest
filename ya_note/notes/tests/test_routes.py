...
class TestRoutes(TestCase):
    ...
    # п.1, 5 Главная страница, логина,логаута, регистрация доступна
    ...
    # п.3 Только автор может удалить/отредактировать/увидеть свою заметку
    ...
    def test_redirect_for_anonymous_client(self):
        ...
        for name in (
            ...
            with self.subTest(name=name):
                # Адрес страницы редактирования или удаления:
                if name == ('notes:list'):
                    url = reverse(name)
                elif name == ('notes:add'):
                    url = reverse(name)
    ...
    # п.2 Аутентифицированному пользователю доступна страница со списком
